...
function preload() {
  ...
  this.load.spritesheet("watergirl", "assets/fireboy-character.png", {frameWidth: 60,frameHeight: 69,});
  this.load.spritesheet("fireboy", "assets/fireboy-character.png", {frameWidth: 60,frameHeight: 69,});
...
function create() {
  ...
  this.fireboy = this.physics.add.sprite(75, 600, "fireboy");
  ...
  this.rivergreen.create(950, 470, "rivergreen").setScale(0.5, 0.5).refreshBody();
  ...
  this.riverblue.create(300, 380, "rivergreen").setScale(0.5, 0.5).refreshBody();
  ...
  player1 = this.physics.add.sprite(50, 600, "fireboy");
